...
//    public Map<String, List<Map<String, Object>>> compareByMallGroup(
//            @RequestBody CompareRequestDto request
//    ) {
//        return naverShoppingService.compareItemsGroupedByMall(request.getConditions(), request.getMallNames());
//    }
//
...
public class NaverShoppingController {
    ...
    @PostMapping("/compare/grouped")
    public ResponseEntity<Map<String, List<Map<String, Object>>>> compareByMallGroup(@RequestBody CompareRequestDto request) {
        Map<String, List<Map<String, Object>>> result = naverShoppingService.compareItemsGroupedByMall(request);
